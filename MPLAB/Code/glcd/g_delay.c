...
void g_DelayRSSetupTime(void)   	/* provides delay for RS Setup Time */
{
...
void g_DelayDBOutput(void) /* provides delay for Data Output */
{
	/* This is DB Output time from E High		*/
	/* required by the LCD controller read 	*/
...
void g_DelayEPulseWidthLow(void)   	/* provides delay for E Pulse Width Low */
{
...
void g_DelayEPulseWidthHigh(void)   	/* provides delay for E Pulse Width High */
{
	/* This is the width of the E signal		*/
...
void g_DelayEPulseWidth(void)   	/* provides delay for E Pulse Width Generic */
{
	/* This is the width of the E signal		*/
	/* required by the LCD controlller read & write  */
	/* for TM162JCAWG1 it is min 150ns worst case */
...
void g_DelayPORXLCD(void) 	/* provides delay for atleast 15msec */
{
...
void g_DelayXLCD(void)  		/* provides delay for atleast 5msec */
{
  long i;
...
void g_Delay600nsXLCD(void)		/* provides delay for 600ns */
{
...
void g_Delay200usXLCD(void)	/* provides delay for 200uS */
{
    int i;
