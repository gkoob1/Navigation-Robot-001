...
badd +44 timers.c
badd +1 prototypes.h
badd +3313 \Proj\MPLAB\h\p30f6015.h
...
exe 'vert 8resize ' . ((&columns * 77 + 77) / 155)
exe '9resize ' . ((&lines * 41 + 27) / 55)
exe 'vert 9resize ' . ((&columns * 77 + 77) / 155)
argglobal
setlocal noarabic
setlocal autoindent
setlocal autoread
...
303
normal zo
let s:l = 148 - ((17 * winheight(0) + 25) / 51)
...
763
normal zo
let s:l = 518 - ((23 * winheight(0) + 20) / 41)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
518
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 95 - ((8 * winheight(0) + 26) / 53)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
95
...
2329
normal zo
let s:l = 3316 - ((0 * winheight(0) + 0) / 1)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
3316
...
351
normal zo
let s:l = 312 - ((25 * winheight(0) + 25) / 51)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
312
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 1236 - ((33 * winheight(0) + 27) / 54)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
1236
