...
silent only
cd ~\Documents\code\mplab\Proj\MPLAB\code
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +382 Session_HOME.vim
badd +27 interrupts.c
badd +183 koob_thesis.c
badd +1 config.h
badd +1 prototypes.h
badd +14 define_hw.h
...
badd +1 port_init.c
badd +36 timers.c
badd +1 \Proj\MPLAB\h\p30f6015.h
badd +165 spi.c
badd +51 rs232.c
badd +27 qei.c
badd +1 i2c.c
badd +1 \Proj\proj.txt
args koob_thesis.c
edit koob_thesis.c
...
let s:l = 321 - ((220 * winheight(0) + 26) / 53)
...
149
normal zo
let s:l = 252 - ((60 * winheight(0) + 19) / 39)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
252
...
exe 'vert 3resize ' . ((&columns * 76 + 77) / 155)
argglobal
setlocal keymap=
setlocal noarabic
setlocal noautoindent
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 63 - ((5 * winheight(0) + 13) / 26)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
63
