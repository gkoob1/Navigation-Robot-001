...
#define DATA_PIN_7          LATBbits.LATB8
#define DATA_PIN_6          LATBbits.LATB9
#define DATA_PIN_5          LATBbits.LATB10
#define DATA_PIN_4          LATBbits.LATB11

#define READ_PIN_7			PORTBbits.RB8
#define READ_PIN_6			PORTBbits.RB9
#define READ_PIN_5			PORTBbits.RB10
...
#define TRIS_DATA_PIN_7     TRISBbits.TRISB8
#define TRIS_DATA_PIN_6     TRISBbits.TRISB9
#define TRIS_DATA_PIN_5     TRISBbits.TRISB10
...
#if defined(_RB12) && defined(_RB13) && defined(_RB14)

/* #defines of the control pins and the corresponding tris pins for 30F */
#define E_PIN               LATBbits.LATB12       /* PORT for E */
#define RW_PIN              LATBbits.LATB13       /* PORT for RW */
#define RS_PIN              LATBbits.LATB14      /* PORT for RS */

#define TRIS_E              TRISBbits.TRISB12    /* TRIS for E */
#define TRIS_RW             TRISBbits.TRISB13    /* TRIS for RW */
#define TRIS_RS             TRISBbits.TRISB14   /* TRIS for RS */
...
/* #defines of the data pins and the corresponding tris pins */
/* The READ_PIN_X #defines must match the corresponding DATA_PIN_X defines */
/*  ANSEL (now ADPCFG) bits settings for digital should be done outside LCD library*/
 ...
 */
void g_OpenXLCD(char) __attribute__ ((section (".libperi")));

/* SetCGRamAddr
 * Sets the character generator address
 */
void g_SetCGRamAddr(char) __attribute__ ((section (".libperi")));

/* SetDDRamAddr
 * Sets the display data address
 */
void g_SetDDRamAddr(char) __attribute__ ((section (".libperi")));

/* BusyXLCD
 * Returns the busy status of the LCD
 */
char g_BusyXLCD(void)    __attribute__ ((section (".libperi")));

/* ReadAddrXLCD
 * Reads the current address
 */
char g_ReadAddrXLCD(void) __attribute__ ((section (".libperi")));

/* ReadDataXLCD
 * Reads a byte of data
 */
char g_ReadDataXLCD(void) __attribute__ ((section (".libperi")));

/* WriteCmdXLCD
 * Writes a command to the LCD
 */
void g_WriteCmdXLCD(char) __attribute__ ((section (".libperi")));

/* WriteDataXLCD
 * Writes a data byte to the LCD
 */
void g_WriteDataXLCD(char) __attribute__ ((section (".libperi")));

/* putsXLCD
 * Writes a string of characters to the LCD
 */
void g_PutsXLCD(char *buffer) __attribute__ ((section (".libperi")));

#define g_putrsXLCD   g_putsXLCD
#define g_getcXLCD    g_ReadDataXLCD
#define g_putcXLCD    g_WriteDataXLCD
...
*/    
void g_DelayRSSetupTime() __attribute__((section (".libperi")));
void g_DelayEPulseWidthLow()   __attribute__ ((section (".libperi")));
void g_DelayEPulseWidthHigh()   __attribute__ ((section (".libperi")));
void g_DelayDBOutput() __attribute__ ((section (".libperi")));
void g_DelayPORXLCD() __attribute__ ((section (".libperi")));

/* general purpose delay functions */
/* kept for backwards compatibility & test purposes*/
void g_DelayXLCD()    __attribute__ ((section (".libperi")));
void g_DelayEPulseWidth()   __attribute__ ((section (".libperi")));
void g_Delay600nsXLCD() __attribute__((section (".libperi")));
#endif
