...
badd +1 timers.c
badd +1 prototypes.h
badd +262 \Proj\MPLAB\h\p30f6015.h
badd +0 \Proj\proj.txt
badd +0 interface.c
args koob_thesis.c
edit koob_thesis.c
...
95
normal zo
let s:l = 118 - ((52 * winheight(0) + 26) / 53)
...
23
normal zo
let s:l = 50 - ((0 * winheight(0) + 13) / 26)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
50
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 66 - ((51 * winheight(0) + 26) / 53)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
66
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 53 - ((22 * winheight(0) + 13) / 26)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
53
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 262 - ((26 * winheight(0) + 27) / 54)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
262
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 885 - ((53 * winheight(0) + 27) / 54)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
885
